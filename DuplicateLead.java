...
//port org.apache.commons.math3.distribution.GammaDistribution;
...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method 
				...
				WebElement name1=driver.findElement(By.id("createLeadForm_companyName"));
				name1.clear();
				name1.sendKeys("TCS");
				
				WebElement name2=driver.findElement(By.id("createLeadForm_firstName"));
				name2.clear();
				name2.sendKeys("Papu");
